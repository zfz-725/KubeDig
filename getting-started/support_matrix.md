# KubeDig Support Matrix

KubeDig supports following types of workloads:
1. **K8s orchestrated**: Workloads deployed as k8s orchestrated containers. In this case, Kubedig is deployed as a [k8s daemonset](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/). Note, KubeDig supports policy enforcement on both k8s-pods ([KubeDigPolicy](security_policy_specification.md)) as well as k8s-nodes ([KubeDigHostPolicy](host_security_policy_specification.md)).
2. **Containerized**: Workloads that are containerized but not k8s orchestrated are supported. KubeDig installed in [systemd mode] can be used to protect such workloads.
3. **VM/Bare-Metals**: Workloads deployed on Virtual Machines or Bare Metal i.e. workloads directly operating as host/system processes. In this case, Kubedig is deployed in [systemd mode].

[systemd mode]: kubedig_vm.md
...
[1540]: https://github.com/zfz-725/KubeDig/issues/1540
...
[1064]: https://github.com/zfz-725/KubeDig/issues/1064
[1084]: https://github.com/zfz-725/KubeDig/issues/1084
[BPFLSM]: https://github.com/zfz-725/KubeDig/issues/484
[Distros]: #Supported-Linux-Distributions
[MKE]: https://www.mirantis.com/software/mirantis-kubernetes-engine/
[1181]: https://github.com/zfz-725/KubeDig/issues/1181
[DOKS]: https://www.digitalocean.com/products/kubernetes/
[1120]: https://github.com/zfz-725/KubeDig/issues/1120
[1650]: https://github.com/zfz-725/KubeDig/issues/1650
...
Please approach the Kubedig community on [slack](https://cloud-native.slack.com/archives/C07EF44HWQM) or [raise](https://github.com/zfz-725/KubeDig/issues/new/choose) a GitHub issue to express interest in adding the support.

It would be very much appreciated if you can test kubedig on a platform not listed above and if you have access to. Once tested you can update this document and raise a PR.
