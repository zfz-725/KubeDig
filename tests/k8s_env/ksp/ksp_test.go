...
import (
	...
	"github.com/zfz-725/KubeDig/protobuf"
	. "github.com/zfz-725/KubeDig/tests/util"
...
var _ = Describe("Ksp", func() {
	...
	BeforeEach(func() {
		ub1 = getUbuntuPod("ubuntu-1", "kubedig-policy: enabled")
		ub3 = getUbuntuPod("ubuntu-3", "kubedig-policy: enabled")
		ub4 = getUbuntuPod("ubuntu-4", "kubedig-policy: enabled")
	})
	...
	Describe("Apply Process Policies", func() {
		It("it can block a process from path for all pods in a group", func() {
			...
			// Start KubeDig Logs in ubuntu-1 pod
			...
			// Start KubeDig Logs in ubuntu-3 pod
	...
	Describe("Apply Files Policies", func() {
		...
		It("it can block access to a file directory recursively using native apparmor spec", func() {
			...
			/*
				skip matching alerts as kubedig doesn't generate
