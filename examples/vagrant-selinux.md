...
1. Environment Setup
    ...
    To test KubeDig for the SELinux-enabled environment, please run the following commands.

    ```text
    $ cd KubeDig/KubeDig
    ~/KubeDig/KubeDig $ make vagrant-up OS=centos
    ```
...
2. Preparation
    ...
    (vagrant) $ cd KubeDig/examples/vagrant-selinux
    (vagrant...vagrant-selinux) $ ./copy.sh
    ```

3. Test

    To verify KubeDig's functionalities, we provide sample host security policies.

    ```text
    (vagrant) $ cd selinux-test/policies
    (vagrant...policies) $ ls
    hsp-kubedig-dev-proc-path-block.yaml
    hsp-kubedig-dev-proc-path-allow-fromSource.yaml
    hsp-kubedig-dev-proc-path-block-fromSource.yaml
    hsp-kubedig-dev-file-path-block.yaml
    hsp-kubedig-dev-file-path-allow-fromSource.yaml
    hsp-kubedig-dev-file-path-allow-fromSource-readOnly.yaml
    hsp-kubedig-dev-file-path-block-fromSource.yaml
    hsp-kubedig-dev-file-path-block-fromSource-readOnly.yaml
    hsp-kubedig-dev-file-dir-allow-fromSource.yaml
    hsp-kubedig-dev-file-dir-block-fromSource.yaml
    ```
    ...
    - hsp-kubedig-dev-proc-path-allow-fromSource.yaml
        ...
        kind: KubeDigHostPolicy
        metadata:
        name: hsp-kubedig-dev-proc-path-allow-fromsource
        spec:
        nodeSelector:
            matchLabels:
            kubernetes.io/hostname: kubedig-dev
    ...
    - hsp-kubedig-dev-proc-path-block-fromSource.yaml
        ...
        kind: KubeDigHostPolicy
        metadata:
        name: hsp-kubedig-dev-proc-path-block-fromsource
        spec:
        nodeSelector:
            matchLabels:
            kubernetes.io/hostname: kubedig-dev
    ...
    - hsp-kubedig-dev-file-path-block.yaml
        ...
        kind: KubeDigHostPolicy
        metadata:
        name: hsp-kubedig-dev-file-path-block
        spec:
        nodeSelector:
            matchLabels:
            kubernetes.io/hostname: kubedig-dev
    ...
    - hsp-kubedig-dev-file-path-allow-fromSource.yaml
        ...
        kind: KubeDigHostPolicy
        metadata:
        name: hsp-kubedig-dev-file-path-allow-fromsource
        spec:
        nodeSelector:
            matchLabels:
            kubernetes.io/hostname: kubedig-dev
    ...
    - hsp-kubedig-dev-file-path-allow-fromSource-readOnly.yaml
        ...
        kind: KubeDigHostPolicy
        metadata:
        name: hsp-kubedig-dev-file-path-block-fromsource-readonly
        spec:
        nodeSelector:
            matchLabels:
            kubernetes.io/hostname: kubedig-dev
    ...
    - hsp-kubedig-dev-file-path-block-fromSource.yaml
        ...
        kind: KubeDigHostPolicy
        metadata:
        name: hsp-kubedig-dev-file-path-block-fromsource
        spec:
        nodeSelector:
            matchLabels:
            kubernetes.io/hostname: kubedig-dev
    ...
    - hsp-kubedig-dev-file-dir-allow-fromSource.yaml
        ...
        kind: KubeDigHostPolicy
        metadata:
        name: hsp-kubedig-dev-file-dir-allow-fromsource
        spec:
        nodeSelector:
            matchLabels:
            kubernetes.io/hostname: kubedig-dev
