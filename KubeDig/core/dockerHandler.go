...
func (dm *KubeDigDaemon) SetContainerVisibility(containerID string) {
...
func (dm *KubeDigDaemon) GetAlreadyDeployedDockerContainers() {
...
func (dm *KubeDigDaemon) UpdateDockerContainer(containerID, action string) {
...
func (dm *KubeDigDaemon) MonitorDockerEvents() {
	dm.WgDaemon.Add(1)
