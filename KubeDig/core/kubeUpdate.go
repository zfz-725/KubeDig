...
func (dm *KubeDigDaemon) GetSecurityPolicies(identities []string, namespaceName string) []tp.SecurityPolicy {
		...
		cache.ResourceEventHandlerFuncs{
			AddFunc: func(obj interface{}) {
				...
				if policy, ok := obj.(*ksp.KubeDigPolicy); ok {
					...
					dm.UpdateSecurityPolicy("ADDED", KubeDigPolicy, secPolicy)
			...
			UpdateFunc: func(oldObj, newObj interface{}) {
				if policy, ok := newObj.(*ksp.KubeDigPolicy); ok {
					...
					// apply security policies to pods
					dm.UpdateSecurityPolicy("MODIFIED", KubeDigPolicy, secPolicy)
				}
			},
			DeleteFunc: func(obj interface{}) {
				if policy, ok := obj.(*ksp.KubeDigPolicy); ok {
					...
					// apply security policies to pods
					dm.UpdateSecurityPolicy("DELETED", KubeDigPolicy, secPolicy)
				}
			},
		},
	)
		...
		cache.ResourceEventHandlerFuncs{
			AddFunc: func(obj interface{}) {
				...
				if policy, ok := obj.(*ksp.KubeDigClusterPolicy); ok {
					...
					// apply security policies to pods
					dm.UpdateSecurityPolicy("ADDED", KubeDigClusterPolicy, secPolicy)
			...
			UpdateFunc: func(oldObj, newObj interface{}) {
				if policy, ok := newObj.(*ksp.KubeDigClusterPolicy); ok {
					...
					// apply security policies to pods
					dm.UpdateSecurityPolicy("MODIFIED", KubeDigClusterPolicy, secPolicy)
				}
			},
			DeleteFunc: func(obj interface{}) {
				if policy, ok := obj.(*ksp.KubeDigClusterPolicy); ok {
					...
					// apply security policies to pods
					dm.UpdateSecurityPolicy("DELETED", KubeDigClusterPolicy, secPolicy)
				}
			},
		},
	)
