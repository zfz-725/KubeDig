...
import (
	...
	"github.com/zfz-725/KubeDig/KubeDig/core"
...
func main() {
	...
	bpfMapsName := []string{"kubedig_config", "kubedig_events", "kubedig_containers", "kubedig_visibility", "kubedig_alert_throttle"}
