...
type Namespace struct {
	...
	KubedigFilePosture    string `json:"kubedig_file_posture,omitempty"`
	KubedigNetworkPosture string `json:"kubedig_network_posture,omitempty"`
...
// K8sKubeDigPolicyEvent Structure
type K8sKubeDigPolicyEvent struct {
	Type   string             `json:"type"`
	Object K8sKubeDigPolicy `json:"object"`
}

// K8sKubeDigPolicy Structure
type K8sKubeDigPolicy struct {
	Metadata metav1.ObjectMeta `json:"metadata"`
	Spec     SecuritySpec      `json:"spec"`
	Status   K8sPolicyStatus   `json:"status,omitempty"`
}

// K8sKubeDigPolicies Structure
type K8sKubeDigPolicies struct {
	Items []K8sKubeDigPolicy `json:"items"`
}

// K8sKubeDigHostPolicyEvent Structure
type K8sKubeDigHostPolicyEvent struct {
	Type   string                 `json:"type"`
	Object K8sKubeDigHostPolicy `json:"object"`
}

// K8sKubeDigHostPolicy Structure
type K8sKubeDigHostPolicy struct {
	Metadata metav1.ObjectMeta `json:"metadata"`
	Spec     HostSecuritySpec  `json:"spec"`
	Status   K8sPolicyStatus   `json:"status,omitempty"`
}

// K8sKubeDigHostPolicies Structure
type K8sKubeDigHostPolicies struct {
	Items []K8sKubeDigHostPolicy `json:"items"`
}
...
type Log struct {
	...
	// KubeDig Version
	KubeDigVersion string `json:"kubeDigVersion,omitempty"`
...
// KubeDigPolicy Flags
const (
	KubeDigPolicyDisabled = 0
	KubeDigPolicyEnabled  = 1
	KubeDigPolicyAudited  = 2
)
...
// KubeDigHostPolicyEventCallback Function
type KubeDigHostPolicyEventCallback func(K8sKubeDigHostPolicyEvent) pb.PolicyStatus
