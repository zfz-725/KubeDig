...
type PolicyServer struct {
	...
	UpdateContainerPolicy  func(tp.K8sKubeDigPolicyEvent) pb.PolicyStatus
	UpdateHostPolicy       func(tp.K8sKubeDigHostPolicyEvent) pb.PolicyStatus
...
func (p *PolicyServer) ContainerPolicy(c context.Context, data *pb.Policy) (*pb.Response, error) {
	...
	policyEvent := tp.K8sKubeDigPolicyEvent{}
...
func (p *PolicyServer) HostPolicy(c context.Context, data *pb.Policy) (*pb.Response, error) {
	...
	policyEvent := tp.K8sKubeDigHostPolicyEvent{}
