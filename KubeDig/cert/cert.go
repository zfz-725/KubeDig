...
const (
	// ORG kubedig
	KubeDig_ORG string = "kubedig"
	KubeDig_CN  string = "kubedig"
)

var DefaultKubeDigServerConfig = CertConfig{
	CN:           KubeDig_CN,
	Organization: KubeDig_ORG,
	KeyUsage:     x509.KeyUsageKeyEncipherment | x509.KeyUsageDigitalSignature,
	ExtKeyUsage:  []x509.ExtKeyUsage{x509.ExtKeyUsageServerAuth},
}

var DefaultKubeDigClientConfig = CertConfig{
	CN:           KubeDig_CN,
	Organization: KubeDig_ORG,
	KeyUsage:     x509.KeyUsageKeyEncipherment | x509.KeyUsageDigitalSignature,
...
var DefaultKubeDigCAConfig = CertConfig{
	CN:           KubeDig_CN,
	Organization: KubeDig_ORG,
	IsCa:         true,
