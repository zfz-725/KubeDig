...
type filelessexecMapSpecs struct {
	...
	KubedigFilelessExecPresetContainers *ebpf.MapSpec `ebpf:"kubedig_fileless_exec_preset_containers"`
}
...
type filelessexecMaps struct {
	...
	KubedigFilelessExecPresetContainers *ebpf.Map `ebpf:"kubedig_fileless_exec_preset_containers"`
}
...
func (m *filelessexecMaps) Close() error {
	return _FilelessexecClose(
		...
		m.KubedigEvents,
		m.KubedigExecPids,
		m.KubedigFilelessExecPresetContainers,
	)
}
