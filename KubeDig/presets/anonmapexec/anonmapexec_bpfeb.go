...
type anonmapexecMapSpecs struct {
	...
	KubedigAnonMapExecPresetContainers *ebpf.MapSpec `ebpf:"kubedig_anon_map_exec_preset_containers"`
...
type anonmapexecMaps struct {
	...
	KubedigAnonMapExecPresetContainers *ebpf.Map `ebpf:"kubedig_anon_map_exec_preset_containers"`
...
func (m *anonmapexecMaps) Close() error {
	return _AnonmapexecClose(
		...
		m.KubedigAnonMapExecPresetContainers,
		m.KubedigConfig,
		m.KubedigContainers,
		m.KubedigEvents,
		m.KubedigExecPids,
