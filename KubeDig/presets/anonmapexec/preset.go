...
func NewAnonMapExecPreset() *AnonMapExecPreset {
	p := &AnonMapExecPreset{}
...
func (p *AnonMapExecPreset) Name() string {
	return NAME
}
...
func (p *AnonMapExecPreset) TraceEvents() {
...
func (p *AnonMapExecPreset) RegisterContainer(containerID string, pidns, mntns uint32) {
...
func (p *AnonMapExecPreset) UnregisterContainer(containerID string) {
	p.ContainerMapLock.Lock()
	defer p.ContainerMapLock.Unlock()
...
func (p *AnonMapExecPreset) AddContainerIDToMap(id string, ckv NsKey, action string) error {
...
func (p *AnonMapExecPreset) DeleteContainerIDFromMap(id string, ckv NsKey) error {
...
func (p *AnonMapExecPreset) UpdateSecurityPolicies(endPoint tp.EndPoint) {
...
func (p *AnonMapExecPreset) Destroy() error {
	if p == nil {
		return nil
	}
