...
type protectenvMapSpecs struct {
	...
	KubedigExecPids                   *ebpf.MapSpec `ebpf:"kubedig_exec_pids"`
	KubedigProtectenvPresetContainers *ebpf.MapSpec `ebpf:"kubedig_protectenv_preset_containers"`
}
...
type protectenvMaps struct {
	...
	KubedigExecPids                   *ebpf.Map `ebpf:"kubedig_exec_pids"`
	KubedigProtectenvPresetContainers *ebpf.Map `ebpf:"kubedig_protectenv_preset_containers"`
}
...
func (m *protectenvMaps) Close() error {
	return _ProtectenvClose(
		...
		m.KubedigEvents,
		m.KubedigExecPids,
		m.KubedigProtectenvPresetContainers,
	)
}
