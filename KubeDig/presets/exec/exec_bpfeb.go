...
type execMapSpecs struct {
	...
	KubedigExecPresetContainers *ebpf.MapSpec `ebpf:"kubedig_exec_preset_containers"`
}
...
type execMaps struct {
	...
	KubedigExecPresetContainers *ebpf.Map `ebpf:"kubedig_exec_preset_containers"`
}
