...
import (
	...
	"github.com/zfz-725/KubeDig/pkg/KubeDigOperator/seccomp"

	"github.com/zfz-725/KubeDig/pkg/KubeDigOperator/common"
	"github.com/zfz-725/KubeDig/pkg/KubeDigOperator/enforcer"
	"github.com/zfz-725/KubeDig/pkg/KubeDigOperator/k8s"
	runtimepkg "github.com/zfz-725/KubeDig/pkg/KubeDigOperator/runtime"
...
var Cmd = &cobra.Command{
	...
	Use:   "snitch",
	Short: "A CLI Utility to Detect node related information for KubeDig",
	Long: `CLI Utility to Detect node related information for KubeDig
...
func snitch() {
	...
	if nodeEnforcer != "NA" {
		...
		Logger.Info("Node doesn't supports any KubeDig Supported Lsm, Enforcement is disabled")
		nodeEnforcer = "none"
	}
