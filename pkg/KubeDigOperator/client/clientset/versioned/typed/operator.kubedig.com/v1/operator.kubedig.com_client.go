...
type OperatorV1Interface interface {
	...
	KubeDigConfigsGetter
}

// OperatorV1Client is used to interact with features provided by the operator.kubedig.com group.
type OperatorV1Client struct {
	restClient rest.Interface
}

func (c *OperatorV1Client) KubeDigConfigs(namespace string) KubeDigConfigInterface {
	return newKubeDigConfigs(c, namespace)
}
