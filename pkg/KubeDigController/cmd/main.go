...
import (
	...
	"github.com/zfz-725/KubeDig/pkg/KubeDigController/handlers"
	"github.com/zfz-725/KubeDig/pkg/KubeDigController/informer"
	controllers "github.com/zfz-725/KubeDig/pkg/KubeDigController/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "191ee55f.kubedig.com",
	...
	if err = (&controllers.KubeDigPolicyReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "KubeDigPolicy")
		os.Exit(1)
	}
	if err = (&controllers.KubeDigHostPolicyReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "KubeDigHostPolicy")
		os.Exit(1)
	}
