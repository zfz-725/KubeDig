...
import (
	...
	"github.com/zfz-725/KubeDig/pkg/KubeDigController/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type SecurityV1Interface interface {
	RESTClient() rest.Interface
	KubeDigClusterPoliciesGetter
	KubeDigHostPoliciesGetter
	KubeDigPoliciesGetter
}

// SecurityV1Client is used to interact with features provided by the security.kubedig.com group.
type SecurityV1Client struct {
	restClient rest.Interface
}

func (c *SecurityV1Client) KubeDigClusterPolicies() KubeDigClusterPolicyInterface {
	return newKubeDigClusterPolicies(c)
}

func (c *SecurityV1Client) KubeDigHostPolicies() KubeDigHostPolicyInterface {
	return newKubeDigHostPolicies(c)
}

func (c *SecurityV1Client) KubeDigPolicies(namespace string) KubeDigPolicyInterface {
	return newKubeDigPolicies(c, namespace)
}
