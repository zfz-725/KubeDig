...
kubectl apply -f deployments/controller/kubedig-controller-mutating-webhook-config.yaml
kubectl wait pods --for=condition=ready -n kubedig -l kubedig-app=kubedig-controller
